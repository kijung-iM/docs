...
public class DefaultWebClient {
    @Weaving
    abstract protected class DefaultRequestBodyUriSpec {
            ...
            return m.doOnError(ex -> {
                ...
                try {
                    ...
                    if (resp != null) {
                        ...
                        String reason = code == 200 ? null : resp.statusCode().getReasonPhrase();
                ...
                if (ConfMTrace.mtrace_enabled) {
                    ...
                    if (ctx != null) {
                        ...
                        if (ConfMTrace.mtid_mtrace_enabled && ctx.mtid != 0) {
                            ...
                            StaticThreadLocal.stepIdTable.set(new Long(stepId));
